...
def _download_args(args_parser):
    ...
    args.add_argument(
        ...
        metavar="zip_name",
        default=None,
        help=("set a custom name for the zip file. "),
    )
    args.add_argument(
        "-sc",
        "--selchap",
        ...
        default=None,
        help=(
            "Select chapters to be downloaded can be singles seperated by ' '"
            "or a range seperated by '-' "
            "you can select specific chapter and a range e.g : '1 2 5-9'"
            "this will download chapters : 1 2 5 6 7 8 9"
        ),
    )
